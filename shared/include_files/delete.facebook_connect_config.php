...
if (isset($_SERVER['HTTP_HOST']) &&
    ($_SERVER['HTTP_HOST'] == 'localhost' || $_SERVER['HTTP_HOST'] == 'p2s.test'  || $_SERVER['HTTP_HOST'] == 'otonomic.test' )
) {
    ...
    if(!defined('NEXT_PAGE_URL')) { define('NEXT_PAGE_URL', 'http://otonomic.test/shared/facebook_fanpages.php'); }
    ...
    if(!defined('FACEBOOK_CONNECT_PATH')) { define('FACEBOOK_CONNECT_PATH', '/shared/'); }
    if(!defined('NEXT_PAGE_URL')) { define('NEXT_PAGE_URL', 'http://otonomic.com/shared/facebook_fanpages.php'); }
}
