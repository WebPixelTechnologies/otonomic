<?php
if (isset($_SERVER['HTTP_HOST']) && ($_SERVER['HTTP_HOST'] == 'localhost' || $_SERVER['HTTP_HOST'] == 'p2s.test' )) {
    ...
    if(!defined('FACEBOOK_APP_ID')) { define('FACEBOOK_APP_ID', '160571960685147'); }
    if(!defined('FACEBOOK_SECRET_KEY')) { define('FACEBOOK_SECRET_KEY', '881023f4df1d34b24da4c79beea423d0'); }
