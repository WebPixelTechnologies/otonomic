...
(function ($, window, document) {
    ...
    $("#search_wrapper_main").delegate(".search-results-item", 'click', function (e) {
        ...
        facebookConversionPixel('6016621432630');
    });
...
function facebookConversionPixel(fb_pixel, fb_value){
    if(typeof(fbvalue) == 'undefined') { fb_value = '0.00'; }
    var image = new Image(1,1);
    // image.src = "https://www.facebook.com/offsite_event.php?id=" + fb_pixel + "&amp;value=" + fb_value + "&amp;currency=USD";
    image.src = "https://www.facebook.com/tr?ev="+fb_pixel+"&amp;cd[value]="+fb_value+"&amp;cd[currency]=USD&amp;noscript=1";
}
