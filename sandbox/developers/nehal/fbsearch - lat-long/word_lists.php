    ...
    <div class="left" style="width: 70%">
        <table width="100%">
            ...
            <?php foreach($data as $keyword => $synonyms): ?>
                ...
                <tr id="index_<?php echo $ii; ?>" class="keyword <?php echo $keyword; ?>" data-index="<?php echo $ii; ?>" data-keyword="<?php echo $keyword;?>" data-additional-data="<?php echo $key;?>">
                    <td><?php echo $ii; ?></td>
        ...
        jQuery(document).ready(function($) {
            ...
            $("#fetch_data").click(function(){
                ...
                $.each($(".keyword:not(.success)"), function(key, value){
                    ...
                    obj.additional_data = $this.data('additional-data');
