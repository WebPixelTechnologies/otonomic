    ...
    <div class="container">
      <section>
        ...
        <div class="row">
          <div class="col-md-3">
            <h4>Come visit</h4>
            <p>22nd Se’adiya Ga’on St.<br>Tel-Aviv, Israel</p>
            <h4>Call us</h4>
            <p>1-400-555-888</p>
          </div>
          <div class="col-md-9">
            <div class="thumbnail google-map">
              <!-- map fold -->
              <img class="map-fold" src="images/map-fold.png">
              <!-- Google map -->
              <iframe width="100%" height="100%" frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?q=22+Seadiya+Gaon+,Tel-Aviv,+Israel&key=AIzaSyA3DS-4yDEFf2dfmg-CAEYELDWxDl7HJwM"></iframe>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-3">
            <h4>Email us or fill a<br>contact form</h4>
          </div>
          <div class="col-md-9">
            <div class="row">
              <div class="col-sm-6">
        ...
        <div class="row social-channels">
          ...
          <div class="col-md-9">
            <ul class="rrssb-buttons contact-buttons clearfix">
              <li class="facebook">
                  <a href="https://www.facebook.com/otonomic" target="_blank">
                      <span class="icon">
              ...
              <li class="twitter">
                  <a href="https://twitter.com/otonomic" target="_blank">
                      <span class="icon">
                          <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="28px" height="28px" viewBox="0 0 28 28" enable-background="new 0 0 28 28" xml:space="preserve">
              ...
              <li class="linkedin">
                  <a href="https://www.linkedin.com/company/otonomic" target="_blank">
                      <span class="icon">
                          <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="28px" height="28px" viewBox="0 0 28 28" enable-background="new 0 0 28 28" xml:space="preserve">
              ...
              <li class="googleplus">
                  <a href="https://plus.google.com/+Otonomic/about" target="_blank">
                      <span class="icon">
                          <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="28px" height="28px" viewBox="0 0 28 28" enable-background="new 0 0 28 28" xml:space="preserve">
                              <g>
                                  <g>
