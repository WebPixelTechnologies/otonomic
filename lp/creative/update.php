...
<body>
	...
	<article class="panel1">
		<h3>
			<br />Create a <b>WEBSITE</b> in 1 click. It will <b>UPDATE</b> 
			<br />from your <b>FACEBOOK</b> page, on the fly!
        ...
        <div class="watch_video">
            <a href="http://youtu.be/c9HlSITDejc"  class="fancybox-media track_event" rel="media-gallery" style="font-size: 17px;" data-ga-category="LandingPage" data-ga-event="Watch Video" data-ga-label="http://youtu.be/c9HlSITDejc" data-ajax-track="1" rel="media-gallery" style="font-size: 17px;">
	...
	<article class="panel2">
		...
		from Facebook <img src="//wwwstatic.verisites.com/lp/creative/images/freebie.png" alt="Free" /> Unlimited amount of content, photos, videos
	...
	<article class="panel4">
		...
		<section class="q-block">
			...
			new to tell the world, simply 
			post it on Facebook. No need to 
			waste time on copying 
			everything to your website and 
			designing it manually. Page2site 
			does it all for you.
