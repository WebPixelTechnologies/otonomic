...
<html>
	<head>
		...
		<link href="//wwwstatic.verisites.com/lp/creative/style/index.css?v=1.0.1" type="text/css" rel="stylesheet" />
        ...
        <style>
			.panel2 { margin-top: 35px; padding-left: 30px;}
			.panel2 img {margin-right: 20px;}
			.panel3 {margin-top: 55px;}
			.panel1 .button1 {margin: 35px auto 75px 40px;}
			.panel4.panel8 { margin-top:0;}
            .media-heading a{text-decoration: none;color: #474747}
            .panel4 { margin: 60px auto 40px;}
            .panel5 {margin-top: 0px;}
		    .panel6 {height: 240px;}
            .panel7 {margin-top: 70px;}
...
<body>
	...
	<article class="panel1">
        ...
        <div class="watch_video">
            <a href="http://youtu.be/c9HlSITDejc" rel="media-gallery" style="font-size: 17px;" class="fancybox-media track_event" rel="media-gallery" style="font-size: 17px;" data-ga-category="LandingPage" data-ga-event="Watch Video" data-ga-label="http://youtu.be/c9HlSITDejc" data-ajax-track="1">
	...
	<article class="panel2">
		FREE <img src="//wwwstatic.verisites.com/lp/creative/images/freebie.png" alt="Free" /> Content from your Facebook page
		<img src="//wwwstatic.verisites.com/lp/creative/images/freebie.png" alt="Free" /> Unlimited amount of posts, photos, videos
	...
	<article class="panel4">
		<section class="q-block">
			...
			and we will create for you a site 
			using the latest web technologies 
			which will look great on any device 
		...
		<section class="q-block">
			...
			<h3>BEAUTIFUL</h3>
			5 templates designed by top 
			professionals to make your 
			content stand out. Feel like a fresh 
			look? You can change your 
			template with just 1 click – all your 
