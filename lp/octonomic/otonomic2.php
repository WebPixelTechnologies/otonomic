        ...
        <div id="main">	
            <div class="container2">
                ...
                <div class="top_wraper2">
                    <h2 class="heading_text">It's free, effortless,<br/>instant and beautiful.<br/><span style="font-weight: bold;">Its Your Website!</span></h2>
                    <p class="text2">Let's enforce your brand and spread your presence. Let's get more customers and make more money. <span style="font-weight: bold;">Let's do it now!</span></p>
                        ...
                        <tr class="form_input2">
                            <td>
                                <div style="position: relative" class="p2s_fanpages">
                                    <input id="main_search_box" type="text" class="input_type input_field" value="" name="fName" placeholder="Enter your Facebook page name (or URL)">
                            ...
                            <td id="btn_go" title='Choose your page from the suggestions below' class="input_title submit_btn">Make my Website</td>
                        </tr>
                        </table>
                    </div>
                </div>
                ...
                <div class="footer_text">Brought to you by <span style="font-family:Myriad Pro;font-size: 14px;">OTONOMIC</span></div>
            </div>                            
        </div>
    </div>
