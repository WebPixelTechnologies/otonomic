...
<article class="panel1-b">
    <div class="container">
        <p>Turn your <strong>FACEBOOK</strong> page Into a beautiful <strong>WEBSITE</strong><br><br>See how it's done in 20 seconds!</p>
        <img src="./images/header-b.png">
    </div>
</article>
<!-- panel1 -->
...
<article class="panel2" style="margin-left: 112px;">
...
<article class="panel3" style="margin-left: 112px;">
