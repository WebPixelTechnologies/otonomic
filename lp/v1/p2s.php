...
<head>
    ...
    <script src="../creative/script/index.js" type="text/javascript"></script>
...
<body>
    ...
    <div class="clear"></div>
<header>
    <section class="container h-block">
...
<article class="panel1">
    ...
    <div class="watch_video">
        <a href="http://youtu.be/c9HlSITDejc" class="fancybox-media track_event" rel="media-gallery" style="font-size: 17px;" data-ga-category="LandingPage" data-ga-event="Watch Video" data-ga-label="http://youtu.be/c9HlSITDejc" data-ajax-track="1">
            <img src="images/play.png" style="vertical-align: middle;margin-right: 5px;margin-top: -3px;">Watch Video
        </a>
    </div>
    ...
    <div class="fbws-block">
        <a href="/shared/facebook_login.php" class="facebook_connect track_event measure_time" data-ga-category="LandingPage" data-ga-event="Connect with Facebook" data-ga-label="step1_button" id="step1_button" data-ajax-track="1" >
            <img src="images/connect.png" alt="Connect with Facebook" />
    ...
    <div class="fbws-arrow">
			<img src="images/cse-arrow.png" alt="arrow" />
    </div>
    <div class="fbws-block">
        <a href="/shared/facebook_login.php" class="facebook_connect track_event measure_time" data-ga-category="LandingPage" data-ga-event="Connect with Facebook" data-ga-label="step2_button" id="step2_button" data-ajax-track="1" >
            <img src="images/select.png" alt="Select your Page" />
    ...
    <div class="fbws-block">
        <a href="/shared/facebook_login.php" class="facebook_connect track_event measure_time" data-ga-category="LandingPage" data-ga-event="Connect with Facebook" data-ga-label="step3_button" id="step3_button" data-ajax-track="1" >
            <img src="images/enjoy.png" alt="Enjoy your Website!" />
...
<!-- panel1 -->
	...
	<article class="panel2">
		FREE <img src="images/freebie.png" alt="Free" /> Automatic updates
		from Facebook <img src="images/freebie.png" alt="Free" /> Full website
...
<article class="panel4">
    ...
    <section class="q-block">
			<img src="images/beautiful.png" alt="Beautiful" />
...
<!-- panel4 -->
    ...
    <section class="e-block">
        <a target="_blank" href="http://griyaspreiandfashions.com/sites/store">
			<img src="images/page2site_griya_store.jpg" alt="Griya Sprei & Fashion" />
    ...
    <section class="e-block">
        <a target="_blank" href="http://coachingdevidahn.com/sites/blog">
			<img src="images/page2site_coaching_de_vida_blog.jpg" alt="Coaching de vida Honduras" />
    ...
    <section class="e-block">
        <a target="_blank" href="http://sklcosmetiques973.com/sites/portfolio">
			<img src="images/page2site_sklcosmetics_photos.jpg" alt="SKL Conseils " />
...
<div class="clear"></div>
    ...
    <div class="arrows">
			<img src="images/l-arrow-d.png" alt="Left Arrow" /><img src="images/r-arrow-e.png" alt="Right Arrow" />
    </div>
    <h2>Testimonials</h2>
    ...
    <section class="testimonials">
        <section class="testimonial" style="display: block;">
            <div class="t-icon">
                <img src="images/user-sonia-robinson.png" alt="Testimonial">
            </div>
            <div class="t-statement">I was surprised by how easy it was to create and customize the website. After years
                of putting off building a site, I finally have one that works and looks great.
            </div>
            <div class="t-author">
        ...
        <section class="testimonial">
            <div class="t-icon">
                <img src="images/user-karl-loupec.png" alt="Testimonial">
            </div>
            <div class="t-statement">I would like to thank the Page2site team for their great service and their
                extraordinary patience. Thanks to them, my site looks even better than I envisioned it and I had 3 new
                customers asking for a price proposal in the first week alone!
            </div>
            <div class="t-author"><p>- Karl Loupec, France </p><a href="http://sklcosmetiques973.com/" class="website">http://sklcosmetiques973.com</a>
            </div>
        </section>
    </section>
    <div class="clear"></div>
...
<div class="clear"></div>
    ...
    <section class="carousel">
        <div class="l-arrow">
				<img src="images/l-arrow-e.png" alt="Left Arrow" />
        </div>
        <div class="c-box">
				<div class="c-block">
					<img src="images/sensation.png" alt="Sensation" />
                <h3>SENSATION</h3>
                <!-- <div class="c-button">Create a site with this template</div> -->
            </div>
				<div class="c-block">
					<img src="images/beulah.jpg" alt="Beulah" />
                <h3>BEULAH</h3>
                <!-- <div class="c-button">Create a site with this template</div> -->
            </div>
				<div class="c-block">
					<img src="images/half-tone.jpg" alt="Half Tone" />
                <h3>HALF TONE</h3>
                <!-- <div class="c-button">Create a site with this template</div> -->
            </div>
				<div class="c-block">
					<img src="images/nova.jpg" alt="Half Tone" />
                <h3>NOVA</h3>
                <!-- <div class="c-button">Create a site with this template</div> -->
            </div>
				<div class="c-block">
					<img src="images/muro.jpg" alt="Half Tone" />
                <h3>MURO</h3>
                <!-- <div class="c-button">Create a site with this template</div> -->
            </div>
        </div>
        <!-- c-box -->
        <div class="r-arrow">
				<img src="images/r-arrow-d.png" alt="Right Arrow" />
        </div>
    </section>
</article>
<!-- panel7 -->
...
<article class="panel4 left panel8">
    ...
    <section class="q-block double">
        ...
        Feel free to visit our <a target="_blank" href="http://localhost/faq">FAQ</a> for more information, or <a href="mailto:support@page2site.com">contact support</a>.
        <br><br>
        ...
        consent. <br>
        Feel free to visit our <a target="_blank" href="http://localhost/privacy">privacy policy</a> or <a target="_blank" href="http://localhost/faq">FAQ</a> for more information, or <a href="mailto:support@page2site.com">contact support</a>.
    </section>
