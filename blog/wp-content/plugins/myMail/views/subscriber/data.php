...
<div id="user_image" title="<?php _e('Source', 'mymail') ?>: Gravatar.com" data-email="<?php echo $post->post_title?>" style="background-image:url(<?php echo $this->get_gravatar_uri($post->post_title, 240)?>)"></div>
<?php if(mymail_option('track_users') && !empty($this->user_data['_meta']['ip'])) : $meta = $this->user_data['_meta'];
	...
	$this->user_data['firstname'] = isset($this->user_data['firstname']) ? $this->user_data['firstname'] : '';
	$this->user_data['lastname'] = isset($this->user_data['lastname']) ? $this->user_data['lastname'] : '';
 ?>
