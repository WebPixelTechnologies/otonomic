...
if($this->campaign_data){
	...
	foreach($campaigns as $id => $data){
		...
		$sent = isset($this->campaign_data[$id]['timestamp']) ? $this->campaign_data[$id]['timestamp'] : $this->campaign_data[$id]['sent'];
?>
	...
	<table class="wp-list-table widefat">
		...
		<tr class="alternate">
		<td width="20%"><?php echo date(get_option('date_format').' '.get_option('time_format'), $sent) ?></td>
