...
<head>
	...
	<script type="text/javascript" src="<?php echo admin_url() ?>load-scripts.php?c=1&load=jquery-core,jquery,json2&amp;ver=<?php global $wp_version; echo $wp_version?>"></script>
