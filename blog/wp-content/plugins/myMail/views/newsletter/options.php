...
<?php 
	if($backgroundlinks = $this->templateobj->get_background_links($post->post_content)) :
		...
		foreach($backgroundlinks as $link){
			?>
			<li><input type="url" class="background-link widefat" value="<?php echo $link?>" data-value="<?php echo $link?>"></li>
			<?php
		}
		?> </ul> <?php
	endif;
