...
<?php if($post->post_status == 'autoresponder') :?>	
	<tr><th><?php _e('Total Sent', 'mymail') ?></th><td> <span class="big"><?php echo number_format_i18n($this->campaign_data['sent']) ?></span>
<?php else: ?>
...
<table id="stats">
	...
	<td width="60">
	<div id="stats_open" class="piechart" data-percent="<?php echo $totals ? ($this->campaign_data['opens']/$totals*100) : 0 ?>"><span>0</span>%</div>
	</td>
	...
	<td width="60">
	<div id="stats_click" class="piechart" data-percent="<?php echo $this->campaign_data['opens'] ? ($this->campaign_data['totaluniqueclicks']/$this->campaign_data['opens']*100) : 0?>"><span>0</span>%</div>
	</td>
	...
	<td width="60">
	<div id="stats_unsubscribes" class="piechart" data-percent="<?php echo $this->campaign_data['opens'] ? ($this->campaign_data['unsubscribes']/$this->campaign_data['opens']*100) : 0 ?>"><span>0</span>%</div>
	</td>
	...
	<td width="60">
	<div id="stats_bounces" class="piechart" data-percent="<?php echo $this->campaign_data['hardbounces'] ? ($this->campaign_data['hardbounces']/($totals+$this->campaign_data['hardbounces'])*100) : 0 ?>"><span>0</span>%</div>
	</td>
