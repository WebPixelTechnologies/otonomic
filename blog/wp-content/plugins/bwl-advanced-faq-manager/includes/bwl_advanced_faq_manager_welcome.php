<?php
    ...
    */
    ...
    function bwl_advanced_faq_welcome_submenu() {
        ...
        add_submenu_page(
                'edit.php?post_type=bwl_advanced_faq', __('Thanks for Installing BWL Advanced FAQ Manager.', 'bwl-adv-faq'), __('Welcome', 'bwl-adv-faq'), 'administrator', 'bwl-advanced-faq-welcome', 'bwl_advanced_faq_welcome'
        );
    }
