...
class A_Digital_Downloads_Form extends Mixin
{
    ...
    function enqueue_static_resources()
    {
        wp_enqueue_script(
            ...
            $this->get_static_url('photocrati-nextgen_pro_lightbox#ecommerce_downloads_settings.js'),
	...
	function _render_digital_downloads_field()
	{
		...
		return $this->object->render_partial('photocrati-nextgen_pro_lightbox#ecommerce/digital_downloads', array(
			'items'					=>	$items,
