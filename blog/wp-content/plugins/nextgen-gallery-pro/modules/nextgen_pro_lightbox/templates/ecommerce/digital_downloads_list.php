<div class="digital_downloads_list">
    ...
    <table style="font-size: 84%">
        <tr>
            <th><?php echo esc_html($i18n->image_header) ?></th>
            <th><?php echo esc_html($i18n->item_description_header) ?></th>
            <th><?php echo esc_html($i18n->resolution_header) ?></th>
            <th><?php echo esc_html($i18n->download_header) ?></th>
        </tr>
        <tr>
        ...
        <?php foreach ($images as $image): ?>
            <tr>
                ...
                <td>
                    <a href="<?php echo esc_attr($image->download_url)?>" download>Download</a>
                </td>
            </tr>
        <?php endforeach ?>
    </table>
