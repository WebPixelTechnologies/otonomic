...
class A_NextGen_Pro_Lightbox_Mail_Form extends Mixin
{
    ...
    function _render_ngg_pro_ecommerce_email_notification_body_field()
    {
        ...
        return $this->_render_textarea_field(
            ...
            "Wrap placeholders in %%param%%. Accepted plaeholders: customer_name, email, total_amount, item_count, shipping_street_address, shipping_city, shipping_state, shipping_zip, shipping_country, order_id, hash, order_details_page, admin_email, blog_name, blog_description, blog_url, site_url, and home_url",
            NULL
        );
    }
