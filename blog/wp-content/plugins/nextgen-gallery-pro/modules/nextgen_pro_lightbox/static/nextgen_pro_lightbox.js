        ...
        bind_images: function() {
            ...
            selector.on('click', function (event) {
                ...
                if (event.handled !== true) {
                    ...
                    var show_sidebar = $(this).data('nplmodal-show-comments') ? '/comments' : '';
                    show_sidebar = $(this).data('nplmodal-show-cart') ? '/cart' : show_sidebar;

                    // Both gallery and image-id can be !, but not at the same time
                    var gallery_id = $(this).data('nplmodal-gallery-id') ? $(this).data('nplmodal-gallery-id') : '!';
                    var gallery_transient = window.nplModalRouted.get_transient(gallery_id);
                    ...
                    // open the pro-lightbox through our backbone.js router
                        ...
                        gallery_id = window.nplModalRouted.get_id_from_transient(gallery_transient);
                        window.nplModalRouted.navigate(
                            window.nplModalRouted.router_slug + '/' + slug + '/' + image_id + show_sidebar,
                            {trigger: true,
                                replace: false
                            }
                        );
                        ...
                        if (typeof revert_image_id != 'undefined') {
                            window.nplModalRouted.image_id = revert_image_id;
                        }
                    }
                }
            });
