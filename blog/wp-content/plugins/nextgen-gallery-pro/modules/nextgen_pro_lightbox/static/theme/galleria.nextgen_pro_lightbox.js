            ...
            sidebar: {
                ...
                render: function(type) {
                    ...
                    if (type != this.get_type()) {
                        ...
                        var content = methods.sidebars[type].render(top.nplModalRouted.image_id);
                        ...
                        self.$('sidebar-container').html(methods.sidebars[type].render(top.nplModalRouted.image_id));
                    }
            ...
            sidebars: {
                comments: {
                    ...
                    load_more: function(id) {
                        if (Galleria.get_npl_setting('enable_comments')) {
                            var precache_ids = [];
                    ...
                    render: function(id) {
                        ...
                        if (!this._cache[id]) {
                            ...
                            this.expanded_request(id, function(data) {
                                methods.sidebar.render(methods.sidebars.comments.get_type(), id);
                                self.$('sidebar-overlay').velocity({opacity: 0});
                            });
                        } else {
                            return this._cache[id]['rendered_view'];
                        }
                    },
                    get_type: function() {
                        return 'comments';
                ...
                cart: {
                    ...
                    events: {
                        ...
                        is_ecommerce_enabled: function(){
                            ...
                            else if (typeof(Galleria_Instance.displayed_gallery.display_settings['original_settings']) != 'undefined') {
            ...
            info: {
                ...
                events: {
                    ...
                    npl_init: function() {
                        ...
                        self.$('info').css({background: Galleria.get_npl_setting('carousel_background_color', '#cecece')});
                    },
                    _image_ran_once: false,
                    image: function() {
