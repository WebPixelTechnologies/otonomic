...
class A_Manual_Pricelist_Form extends Mixin
{
	...
	function _render_manual_pricelist_items_field()
	{
		...
		return $this->object->render_partial('photocrati-nextgen_pro_lightbox#ecommerce/manual_pricelist', array(
			'items'				=>	$items,
	...
	{
		wp_enqueue_style( 'ngg-pro-lightbox-admin', $this->object->get_static_url('photocrati-nextgen_pro_lightbox#admin.css'));
		wp_enqueue_script('ngg-pro-lightbox-admin', $this->object->get_static_url('photocrati-nextgen_pro_lightbox#admin.js'));
	}
}