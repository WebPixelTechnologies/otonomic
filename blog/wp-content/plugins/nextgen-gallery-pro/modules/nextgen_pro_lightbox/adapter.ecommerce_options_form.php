...
class A_Ecommerce_Options_Form extends Mixin
{
    ...
    function save_action()
    {
        ...
        if ($ecommerce['page_checkout'] == '')
            $settings->ecommerce_page_checkout = $this->create_new_page('Cart', '[ngg_pro_checkout]');
        else
    ...
    function enqueue_static_resources()
    {
        wp_enqueue_style(
          'photocrati-nextgen_pro_ecommerce_options',
           $this->get_static_url('photocrati-nextgen_pro_lightbox#ecommerce_options.css')
        );

        wp_enqueue_script(
            'photocrati-nextgen_pro_ecommerce_options-settings-js',
            $this->get_static_url('photocrati-nextgen_pro_lightbox#ecommerce_options_form_settings.js'),
            'jquery'
        );
    ...
    function _render_nextgen_pro_ecommerce_page_checkout_field($model)
    {
        ...
        return $this->_render_select_field(
            ...
            "Selecting \"Create new\" will create a new page that will appear in your Primary Menu unless you've customized your menu settings: http://codex.wordpress.org/Appearance_Menus_SubPanel"
        );
    }
