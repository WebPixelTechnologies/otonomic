...
class A_Reset_Ecommerce_Settings_Form extends Mixin
{
    function initialize()
    {
        $this->object->add_post_hook('render', __CLASS__, $this, 'render_ecommerce_warning');
    }

    function render_ecommerce_warning()
    {
        ...
        if (($index = strrpos($retval, '</td>')) !== FALSE) {
            ...
            $this->object->set_method_property(
                $this->method_called, ExtensibleObject::METHOD_PROPERTY_RETURN_VALUE, $retval
            );
        }
