...
function roots_widgets_init() {
 ...
 register_sidebar(array(
  ...
  register_sidebar(array(
    ...
    'id'            => 'sidebar-footer',
    'before_widget' => '<section class="widget %1$s %2$s"> <div class="footer"><div class="container">
       <div class="row">
  ...
  register_sidebar(array(
    ...
    'id'            => 'sidebar-footer1',
    'before_widget' => '<div class="col-xs12 col-sm-5 hidden-xs">',
    'after_widget'  => '</div>',
    'before_title'  => '<h3>',
    'after_title'   => '</h3>',
  ));
   ...
   register_sidebar(array(
    ...
    'id'            => 'sidebar-footer2',
    'before_widget' => ' <div class="col-xs12 col-sm-4 hidden-xs">',
    'after_widget'  => '</div>
        </div>',
    'before_title'  => '<h3>',
    'after_title'   => '</h3>',
  ...
  register_sidebar(array(
    ...
    'id'            => 'sidebar-footer3',
    'before_widget' => '<div class="lower-part">',
    'after_widget'  => '</div>
      </div>
    </div></section>',
    'before_title'  => '<h3>',
